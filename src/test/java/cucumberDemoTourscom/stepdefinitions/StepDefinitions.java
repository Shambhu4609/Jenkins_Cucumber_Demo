...
public class StepDefinitions {
	...
	*/
	@Given("Application is opened in the browser")
	public void application_is_opened_in_the_browser() {
	   System.out.println("Application is opened in the browser");
	     
	}

	@When("All the Data fields has been filled")
	public void all_the_Data_fields_has_been_filled() {
	   System.out.println("All the Data fields has been filled");
	     
	}

	@Then("Submit button is pressed to register")
	public void submit_button_is_pressed_to_register() {
	   System.out.println("Submit button is pressed to register");
	     
	}

	@Given("Application is opened in the chrome browser")
	public void application_is_opened_in_the_chrome_browser() {
	   System.out.println("Application is opened in the chrome browser");
	     
	}

	@When("All the Data fields has been filleds")
	public void all_the_Data_fields_has_been_filleds() {
	   System.out.println("All the Data fields has been filleds");
	}   

	@Then("user submit button is pressed to register")
	public void user_submit_button_is_pressed_to_register() {
	   System.out.println("user submit button is pressed to register");
